(defproject smartyper "0.1.0-SNAPSHOT"
  ...
  :ring {:handler smartyper.handler/app
         :uberwar-name "smartyper.war"}

  :min-lein-version "2.5.0"

  :uberjar-name "smartyper.jar"

  :main smartyper.server
  ...
  :profiles {:dev {:repl-options {:init-ns smartyper.repl
                                  :nrepl-middleware [
